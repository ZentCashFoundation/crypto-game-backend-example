    ...
    plugins: [
      ...
      new CopyWebpackPlugin({
        patterns: [
          ...
          {
            from: require.resolve("../dev-helpers/favicon-16x16.png"),
            to: ".",
          },
          {
            from: require.resolve("../dev-helpers/favicon-32x32.png"),
            to: ".",
          },
          {
            from: require.resolve("../dev-helpers/swagger-initializer.js"),
            to: ".",
          },
          {
            from: require.resolve("../swagger.yaml"),
            to: ".",
          },
          {
          ...
          {
            from: require.resolve("../index.html"),
            to: ".",
          },
        ],
      }),
